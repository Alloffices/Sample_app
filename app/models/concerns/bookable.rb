module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      tennis_court.bookings.end_during(start_time, end_time),
      tennis_court.bookings.start_during(start_time, end_time),
      tennis_court.bookings.happening_during(start_time, end_time),
      tennis_court.bookings.enveloping(start_time, end_time),
      tennis_court.bookings.identical(start_time, end_time)
    ].flatten
